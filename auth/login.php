...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    try {
        ...
        $statm = $conn->prepare("select * from users where email = :email");
        ...
        if($user) {
            if($user->password == $password) {
                ...
                $errors['email'] = 'اطلاعات شما با هم مطابقت ندارد';
            };
        } else {
    ...
    <div class="container mx-auto space-y-4">
        ...
        <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
            <div class="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
                <form class="space-y-6" action="http://localhost/oop/oop-challenge/auth/login.php" method="POST">
                    <div>
